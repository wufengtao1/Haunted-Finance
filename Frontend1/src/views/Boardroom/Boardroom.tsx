      ...
      return (
        <StyledNoticeWrapper>
          <Notice color="green">
            ...
            <b>to continue earning hCASH seigniorage.</b>
          </Notice>
        </StyledNoticeWrapper>
      );
    }
      ...
      <Switch>
        <Page>
          <PageHeader
            ...
            subtitle="Deposit Haunted Shares and earn inflationary rewards"
          />
          <LaunchCountdown
            deadline={config.boardroomLaunchesAt}
            description="How does the boardroom work?"
            descriptionLink="https://docs.haunted.cash/mechanisms/stabilization-mechanism#expansionary-policy"
          />
        </Page>
      </Switch>
    );
